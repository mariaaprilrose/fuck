// based on countries.js by Shafiul Azam at http://bdhacker.wordpress.com/2009/11/21/adding-dropdown-country-state-list-dynamically-into-your-html-form-by-javascript/
...
s_a[52]="Aitutaki|Atiu|Aa|Mangaia|Manihiki|Manuae|Mauke|Mitiaro|Nassau Island|Palmerston|Penrhyn|Pukapuka|Rakahanga|Rarotonga|Suwarrow|Takutea";
...
s_a[55]="Bjeloko-Bilogorska Zupanija|Brodsko-Posavska Zupanija|Dubrovacko-Neretvanska Zupanija|Istarska Zupanija|Karlovacka Zupanija|Koprivnicko-Krizevacka Zupanija|Krapinsko-Zagorska Zupanija|Licko-Senjska Zupanija|Medimurska Zupanija|Osjecko-Baranjska Zupanija|Pozesko-Slavonska Zupanija|Primorsko-Goranska Zupanija|Sibensko-Kninska Zupanija|Sisacko-Moslavacka Zupanija|Splitsko-Dalmatinska Zupanija|Varazdinska Zupanija|Viroviticko-Podravska Zupanija|Vukoko-Srijemska Zupanija|Zadarska Zupanija|Zagreb|Zagrebacka Zupanija";
...
s_a[58]="Brnensky|Budejovicky|Jihlavsky|Karloky|Kralovehradecky|Liberecky|Olomoucky|Ostravsky|Pardubicky|Plzensky|Praha|Stredocesky|Ustecky|Zlinsky";
...
s_a[63]="Azuay|BoliCanar|Carchi|Chimborazo|Cotopaxi|El Oro|Esmeraldas|Galapagos|Guayas|Imbabura|Loja|Los Rios|Manabi|Morona-Santiago|Napo|Orellana|Pastaza|Pichincha|Sucumbios|Tungurahua|Zamora-Chinchipe";
...
s_a[103]="Bacs-Kiskun|Baranya|Bekes|Bekescsaba|Borsod-Abauj-Zemplen|Budapest|Csongrad|Debrecen|Dunaujs|Eger|Fejer|Gyor|Gyor-Moson-Sopron|Hajdu-Bihar|Heves|Hodmezovasarhely|Jasz-Nagykun-Szolnok|KaposKecskemet|Komarom-Esztergom|Miskolc|Nagykanizsa|Nograd|Nyiregyhaza|Pecs|Pest|Somogy|Sopron|Szabolcs-Szatmar-Bereg|Szeged|SzekesfeherSzolnok|Szombathely|Tatabanya|Tolna|Vas|Veszprem|Veszprem|Zala|Zalaegerszeg";
...
s_a[242]="Amazonas|Anzoategui|Apure|Aragua|Barinas|BoliCarabobo|Cojedes|Delta Amacuro|Dependencias Federales|Distrito Federal|Falcon|Guarico|Lara|Merida|Miranda|Monagas|Nueva Esparta|Portuguesa|Sucre|Tachira|Trujillo|Vargas|Yaracuy|Zulia";
...
function populate_countries(i) {
    if (i == 1) {
        $('#signup_box #country').append('<option selected disabled>Select Country</option>');
        for (c in country_arr) {
            $('#signup_box #country').append('<option value = "' + country_arr[c] + '">' + country_arr[c] + '</option>');
        }

        $('#signup_box #country').change(function() {
            country_index = $('#signup_box #country').prop('selectedIndex');
            states = s_a[country_index].split('|');
            $('#signup_box #state option').remove();
            $('#signup_box #state').append('<option selected disabled>Select State</option>');
            for (s in states) {
                $('#signup_box #state').append('<option value = "' + states[s] + '">' + states[s] + '</option>');
            }
        });
    } else if (i == 2) {
        $('#signup_form #country').append('<option selected disabled>Select Country</option>');
        for (c in country_arr) {
            $('#signup_form #country').append('<option value = "' + country_arr[c] + '">' + country_arr[c] + '</option>');
        }

        $('#signup_form #country').change(function() {
            country_index = $('#signup_form #country').prop('selectedIndex');
            states = s_a[country_index].split('|');
            $('#signup_form #state option').remove();
            $('#signup_form #state').append('<option selected disabled>Select State</option>');
            for (s in states) {
                $('#signup_form #state').append('<option value = "' + states[s] + '">' + states[s] + '</option>');
            }
        });
    }
}